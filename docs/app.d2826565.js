var t,e,n,s,o,i,a,r,l,c,d,u,h,f,g,p,E,m,C,y,O,v,_,I,T,N=globalThis,A={},R={},S=N.parcelRequire94c2;null==S&&((S=function(t){if(t in A)return A[t].exports;if(t in R){var e=R[t];delete R[t];var n={id:t,exports:{}};return A[t]=n,e.call(n.exports,n,n.exports),n.exports}var s=Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){R[t]=e},N.parcelRequire94c2=S),S.register;var w=S("ilpIi"),b=S("8XP4m");(t=h||(h={})).STRING="string",t.NUMBER="number",t.INTEGER="integer",t.BOOLEAN="boolean",t.ARRAY="array",t.OBJECT="object",(e=f||(f={})).LANGUAGE_UNSPECIFIED="language_unspecified",e.PYTHON="python",(n=g||(g={})).OUTCOME_UNSPECIFIED="outcome_unspecified",n.OUTCOME_OK="outcome_ok",n.OUTCOME_FAILED="outcome_failed",n.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $(t){return t.text=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new D(`${q(t)}`,t);return function(t){var e,n,s,o;let i=[];if(null===(n=null===(e=t.candidates)||void 0===e?void 0:e[0].content)||void 0===n?void 0:n.parts)for(let e of null===(o=null===(s=t.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)e.text&&i.push(e.text),e.executableCode&&i.push("\n```"+e.executableCode.language+"\n"+e.executableCode.code+"\n```\n"),e.codeExecutionResult&&i.push("\n```\n"+e.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}(t)}if(t.promptFeedback)throw new D(`Text not available. ${q(t)}`,t);return""},t.functionCall=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new D(`${q(t)}`,t);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),j(t)[0]}if(t.promptFeedback)throw new D(`Function call not available. ${q(t)}`,t)},t.functionCalls=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new D(`${q(t)}`,t);return j(t)}if(t.promptFeedback)throw new D(`Function call not available. ${q(t)}`,t)},t}function j(t){var e,n,s,o;let i=[];if(null===(n=null===(e=t.candidates)||void 0===e?void 0:e[0].content)||void 0===n?void 0:n.parts)for(let e of null===(o=null===(s=t.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)e.functionCall&&i.push(e.functionCall);return i.length>0?i:void 0}const K=[y.RECITATION,y.SAFETY,y.LANGUAGE];function Y(t){return!!t.finishReason&&K.includes(t.finishReason)}function q(t){var e,n,s;let o="";if((!t.candidates||0===t.candidates.length)&&t.promptFeedback)o+="Response was blocked",(null===(e=t.promptFeedback)||void 0===e?void 0:e.blockReason)&&(o+=` due to ${t.promptFeedback.blockReason}`),(null===(n=t.promptFeedback)||void 0===n?void 0:n.blockReasonMessage)&&(o+=`: ${t.promptFeedback.blockReasonMessage}`);else if(null===(s=t.candidates)||void 0===s?void 0:s[0]){let e=t.candidates[0];Y(e)&&(o+=`Candidate was blocked due to ${e.finishReason}`,e.finishMessage&&(o+=`: ${e.finishMessage}`))}return o}function W(t){return this instanceof W?(this.v=t,this):new W(t)}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function X(t,e,n,s){return function(t){let[e,n]=(function(t){let e=t.getReader();return new ReadableStream({start(t){let n="";return function s(){return e.read().then(({value:e,done:o})=>{let i;if(o){if(n.trim()){t.error(new x("Failed to parse stream"));return}t.close();return}let a=(n+=e).match(J);for(;a;){try{i=JSON.parse(a[1])}catch(e){t.error(new x(`Error parsing JSON response: "${a[1]}"`));return}t.enqueue(i),a=(n=n.substring(a[0].length)).match(J)}return s()})}()}})})(t.body.pipeThrough(new TextDecoderStream("utf8",{fatal:!0}))).tee();return{stream:function(t){return function(t,e,n){if(!Symbol.asyncIterator)throw TypeError("Symbol.asyncIterator is not defined.");var s,o=n.apply(t,e||[]),i=[];return s={},a("next"),a("throw"),a("return"),s[Symbol.asyncIterator]=function(){return this},s;function a(t){o[t]&&(s[t]=function(e){return new Promise(function(n,s){i.push([t,e,n,s])>1||r(t,e)})})}function r(t,e){try{var n;(n=o[t](e)).value instanceof W?Promise.resolve(n.value.v).then(l,c):d(i[0][2],n)}catch(t){d(i[0][3],t)}}function l(t){r("next",t)}function c(t){r("throw",t)}function d(t,e){t(e),i.shift(),i.length&&r(i[0][0],i[0][1])}}(this,arguments,function*(){let e=t.getReader();for(;;){let{value:t,done:n}=yield W(e.read());if(n)break;yield yield W($(t))}})}(e),response:V(n)}}(await P(e,I.STREAM_GENERATE_CONTENT,t,!0,JSON.stringify(n),s))}async function z(t,e,n,s){let o=await P(e,I.GENERATE_CONTENT,t,!1,JSON.stringify(n),s);return{response:$(await o.json())}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tc{constructor(t){this.apiKey=t}getGenerativeModel(t,e){if(!t.model)throw new x("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new tl(this.apiKey,t,e)}getGenerativeModelFromCachedContent(t,e,n){if(!t.name)throw new B("Cached content must contain a `name` field.");if(!t.model)throw new B("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==e?void 0:e[n])&&t[n]&&(null==e?void 0:e[n])!==t[n]){if("model"===n&&(e.model.startsWith("models/")?e.model.replace("models/",""):e.model)===(t.model.startsWith("models/")?t.model.replace("models/",""):t.model))continue;throw new B(`Different value for "${n}" specified in modelParams (${e[n]}) and cachedContent (${t[n]})`)}let s=Object.assign(Object.assign({},e),{model:t.model,tools:t.tools,toolConfig:t.toolConfig,systemInstruction:t.systemInstruction,cachedContent:t});return new tl(this.apiKey,s,n)}}var td=S("hRA4F"),tu=S("1zsFO"),th=S("8VxNA");const tf=document.getElementById("chatbot-container"),tg=document.getElementById("open-chatbot"),tp=document.getElementById("close-chatbot"),tE=document.getElementById("ai-chat-input"),tm=document.getElementById("chat-history");async function tC(t){ty("ChatBot: "+(await T.generateContent(t)).response.text())}function ty(t){let e=document.createElement("p");e.textContent=t,e.className="history",tm.appendChild(e),tE.value=""}(async function t(){T=new tc((await (0,w.getDoc)((0,w.doc)(b.db,"apikey","googlegenai"))).data().key).getGenerativeModel({model:"gemini-1.5-flash"})})(),document.getElementById("chatbot-form").addEventListener("submit",async t=>{t.preventDefault();let e=(0,tu.sanitizeInput)(tE.value.trim());ty("You: "+e),e?(tE.value="",!function(t){let e=t.toLowerCase();if(console.log(e),e.startsWith("add book")){let e=t.slice(8).trim();return e?((0,tu.openBookForm)(null,e),ty("ChatBot: Book Form for "+e+" open!")):((0,tu.openBookForm)(),ty("ChatBot: Book Form open!")),!0}if(e.startsWith("close chat"))return tf.style.display="none",!0;if(e.startsWith("order by")){let e=t.slice(8).trim(),n=e.split(" ")[0],s=e.split(" ")[1];return(void 0===s&&(s="asc"),s.startsWith("asc")&&s.startsWith("desc"))?ty("ChatBot: Please specify an order of 'asc' or 'desc'!"):n&&["title","author","progress","rating"].includes(n)?((0,th.displayBooks)((0,tu.orderBooksArrayBy)((0,th.getBooks)(),n,s)),ty("ChatBot: Books ordered by "+n+" in "+(s=s.startsWith("asc")?"ascending":"descending")+" order!")):ty("ChatBot: Please specify a valid field to order by! (title, author, progress or rating)"),!0}return!!e.startsWith("sign out")&&((0,b.auth).signOut(),window.location="index.html",!0)}(e)&&await tC(e)):ty("Please enter a prompt"),tm.scrollTop=tm.scrollHeight}),tf.addEventListener("click",()=>{tf.classList.toggle("expanded")}),tg.addEventListener("click",()=>{tf.style.display="block",(0,td.closeMenu)(),tE.focus()}),tp.addEventListener("click",()=>{tf.style.display="none"});
//# sourceMappingURL=app.d2826565.js.map
