function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t=globalThis,r={},n={},i=t.parcelRequire94c2;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequire94c2=i);var s=i.register;s("8XP4m",function(t,r){e(t.exports,"db",()=>l),e(t.exports,"auth",()=>u),e(t.exports,"getBooksFromFirestore",()=>h),e(t.exports,"addBookToFirestore",()=>c),e(t.exports,"updateBookInFirestore",()=>f),e(t.exports,"removeBookFromFirestore",()=>d),i("fhN3L");var n=i("7xvHX");i("ilpIi");var s=i("9HrqM");i("6AR8M");var o=i("guynj");let a=(0,n.initializeApp)({apiKey:"AIzaSyBaagj6KQC06Dj9Jq2l3RZ-MnzebuGcnK8",authDomain:"codex-8c3dd.firebaseapp.com",projectId:"codex-8c3dd",storageBucket:"codex-8c3dd.firebasestorage.app",messagingSenderId:"41268053166",appId:"1:41268053166:web:8ba1a0503f7a72b6f2d93f"}),l=(0,s.getFirestore)(a),u=(0,o.o)(a);async function h(e){let t=u.currentUser;if(!t){console.log("User is not authenticated");return}let r=(0,s.query)((0,s.collection)(l,"codex"),(0,s.where)("email","==",t.email));(await (0,s.getDocs)(r)).docs.forEach(t=>{let r={id:t.id,...t.data()};e.push(r)})}async function c(e){let t=u.currentUser;if(!t){console.log("User is not authenticated");return}return e.email=t.email,(await (0,s.addDoc)((0,s.collection)(l,"codex"),e)).id}async function f(e){let t=u.currentUser;if(!t){console.log("User is not authenticated");return}let r=(0,s.doc)(l,"codex",e.id);if((await (0,s.getDoc)(r)).data().email!==t.email){console.log("User is not the owner of the book");return}await (0,s.updateDoc)(r,{cover:e.cover,title:e.title,author:e.author,genre:e.genre,progress:e.progress,status:e.status,rating:e.rating})}async function d(e){let t=u.currentUser;if(!t){console.log("User is not authenticated");return}let r=(0,s.doc)(l,"codex",e);if((await (0,s.getDoc)(r)).data().email!==t.email){console.log("User is not the owner of the book");return}await (0,s.deleteDoc)(r)}}),s("fhN3L",function(t,r){e(t.exports,"initializeApp",()=>i("7xvHX").initializeApp),e(t.exports,"registerVersion",()=>i("7xvHX").registerVersion),/**
 * @license
